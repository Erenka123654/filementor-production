/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 1a3e3ee0fead22eb2d1501d28d7e2977)
// Runtime types generated with workerd@1.20260708.1 2026-07-16 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AI: Ai;
	IYZICO_ENVIRONMENT: "sandbox";
	AI_MODEL: "@cf/meta/llama-3.1-8b-instruct-fast";
	CONTACT_FROM_EMAIL: "noreply@mail.filementorstudio.net";
	CONTACT_TO_EMAIL: "info@filementorstudio.net";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "IYZICO_ENVIRONMENT" | "AI_MODEL" | "CONTACT_FROM_EMAIL" | "CONTACT_TO_EMAIL" | "SESSION_SECRET" | "IYZICO_API_KEY" | "IYZICO_SECRET_KEY" | "RESEND_API_KEY">> {}
}
